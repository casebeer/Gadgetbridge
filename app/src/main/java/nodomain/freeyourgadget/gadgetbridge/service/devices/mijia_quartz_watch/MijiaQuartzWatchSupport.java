...
package nodomain.freeyourgadget.gadgetbridge.service.devices.mijia_quartz_watch;
...
import nodomain.freeyourgadget.gadgetbridge.devices.mijia_quartz_watch.MijiaQuartzWatchConstants;
...
public class MijiaQuartzWatchSupport extends AbstractBTLEDeviceSupport {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(MijiaQuartzWatchSupport.class);
...
//                    break;
    ...
    public MijiaQuartzWatchSupport() {
        super(LOG);
...
//        }
    ...
    // only supports single notification type
    private void sendNotification() {
        try {
            TransactionBuilder builder = performInitialized("findDevice");
            byte[] value = new byte[]{GattCharacteristic.HIGH_ALERT};

            BluetoothGattService service = btGatt.getService(GattService.UUID_SERVICE_IMMEDIATE_ALERT);
            BluetoothGattCharacteristic charact = service.getCharacteristic(GattCharacteristic.UUID_CHARACTERISTIC_ALERT_LEVEL);
...
//    }
    ...
    public MijiaQuartzWatchSupport initialize(TransactionBuilder builder) {
...
//
    ...
    public boolean onCharacteristicChanged(BluetoothGatt gatt,
        ...
        return false; // handling no characteristics for now
    }
//
